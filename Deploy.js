...
const SHEET_SCHEMA = [
  {
    name: '人員主檔',
    headers: ['信箱', '姓名', '員工狀態', '電話', '手機', '到職日期', '離職日期', '工作地點'],
    notes:   [
      'Primary Key：全系統唯一，格式須符合 email 規範',
      '員工中文全名',
      '限定值：在勤／育嬰假／休假／合作單位／委外廠商／倫理委員會／離職',
      '市話／分機（選填）',
      '行動電話（選填）',
...
/**
 * 注入人員主檔測試資料
 * 欄位：信箱 | 姓名 | 員工狀態 | 電話 | 手機 | 到職日期 | 離職日期 | 工作地點
 *
 * 角色測試帳號：
...
function injectPersonnel_() {
  const data = [
    // [信箱,              姓名,         員工狀態,   電話,            手機,            到職日期,      離職日期, 工作地點]
    ['e001@example.org',        '王代表',         '在勤',     '02-1234-0001',  '0911-000-001',  '2018/01/02',  '',  'bioit'],
    ['e002@example.org',        '李執行長',       '在勤',     '02-1234-0002',  '0911-000-002',  '2018/03/15',  '',  'bioit'],
    ['e003@example.org',        '張生醫部長',     '在勤',     '02-1234-0003',  '0911-000-003',  '2019/06/01',  '',  'bioit'],
    ['e004@example.org',        '陳資訊部長',     '在勤',     '02-1234-0004',  '0911-000-004',  '2019/09/10',  '',  'bioit'],
    ['e005@example.org',        '林行政部長',     '在勤',     '02-1234-0005',  '0911-000-005',  '2020/02/03',  '',  'bioit'],
    ['e006@example.org',        '小明',           '在勤',     '02-1234-0006',  '0911-000-006',  '2021/07/19',  '',  'station'],
    ['e007@example.org',        '小華',           '育嬰假',   '02-1234-0007',  '0911-000-007',  '2021/08/02',  '',  'bioit'],
    ['e008@example.org',        '何人資',         '在勤',     '02-1234-0008',  '0911-000-008',  '2020/11/23',  '',  'bioit'],
    ['e009@example.org',        '周稽核',         '在勤',     '02-1234-0009',  '0911-000-009',  '2022/01/10',  '',  'bioit'],
    ['e010@example.org',        '吳組長',         '休假',     '02-1234-0010',  '0911-000-010',  '2019/04/08',  '',  'station'],
    ['e011@example.org',        '鄭專員',         '休假',     '02-1234-0011',  '0911-000-011',  '2022/05/16',  '',  'outside'],
